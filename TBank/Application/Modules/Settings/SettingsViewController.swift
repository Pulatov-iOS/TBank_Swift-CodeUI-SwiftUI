...
//MARK: - Configurations of Navigation bar
    ...
    private func addSubviews() {
        view.addSubviews(with: termsOfUseView, privacyPolicyView)
    ...
    private func configureConstraints() {
        ...
        termsOfUseView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20).isActive = true
